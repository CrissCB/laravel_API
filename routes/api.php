...
Route::middleware([KeycloakAuth::class])->group(function () {
    ...
    Route::get('/categoria_productos/categoria/{id}', [catproducto_Controller::class, 'showId']);
    ...
    Route::get('/producto/emprendimiento/{id}', [producto_controller::class, 'getIdEmprendimiento']);
